  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-base select-none">
        ...
        <section className="pt-40 pb-20 text-center px-6 fade-up">
          ...
          {/* Mobile tab switcher — shown only on small screens below hero */}
          <div
            className="flex md:hidden items-center p-[3px] gap-[2px] mb-8 mx-auto w-fit"
            style={{
          ...
          >
            {(["voice", "chat", "rag"] as const).map((tab) => (
              <button
                ...
                className="px-5 py-1.5 text-[13px] font-medium capitalize transition-all duration-200"
                style={{
                  borderRadius: "8px",
